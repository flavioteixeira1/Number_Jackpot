...
let tentativa = 3; //Número de tentativas que a pessoa tem
...
var speed = 500; //tempo no intervalo da alternância dos randômicos 
...
function showSpeed(){
    document.getElementById("b1").innerHTML = "INTERVALO " + speed
}
